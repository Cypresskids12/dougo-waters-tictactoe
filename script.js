...
function gameplay() {  //function defination
...
function checkWin() {
    if (button1.textContent.trim() == "X" && button2.textContent.trim() == "X" && button3.textContent.trim() == "X" || //x horizontal
...
function endOfGame(winner) {
    ...
    const word = document.createElement('hi');    //create h1 element
